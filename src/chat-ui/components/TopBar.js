        ...
        <header className="fixed top-0 left-0 w-full z-50 h-16 bg-[#15172c] flex items-center px-8 border-b border-[#282e5e]">
            <div className="flex-1 flex items-center">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-blue-300">สร้าง AI Assistant ด้วยตนเอง</span>
            ...
            <div className="flex items-center space-x-3">
                ...
                <button className="p-2 rounded-full hover:bg-[#22264c]">
                    <svg width="18" height="18" fill="none" stroke="#b4b8ff" strokeWidth="2" viewBox="0 0 24 24">
                        ...
                        <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83v0a2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V20a2 2 0 0 1-2 2h0a2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 7 18.67a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0v0a2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82A1.65 1.65 0 0 0 4 12.91V12a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83v0a2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 7 5.33V4a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v.09c.3.04.59.14.85.31" />
                    </svg>
                </button>
